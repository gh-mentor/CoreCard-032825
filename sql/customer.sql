...
- CustomerID: Foreign key referencing CustomerID in the Customer table, cannot be null.
- CardToken: Unique token or reference provided by the third-party authority, cannot be null.
...
7) Add triggers to update the UpdateDate of the CreditCard table column on modification

8) Create the InsertCustomerAndAccount stored procedure which inserts a new customer, account, and initial transaction:
